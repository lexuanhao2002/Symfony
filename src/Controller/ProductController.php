...
class ProductController extends AbstractController
{
    ...
    public function editAction(ManagerRegistry $doctrine, $id, Request $request)
    {
        ...
        if ($form->isSubmitted()) {
            ...
            return new Response('edit' . $product->getId());
        }
     ...
     */
    public function createAct(ManagerRegistry $doctrine, Request $request)
    {
        $category = new Category();
    ...
    public function save(ManagerRegistry $doctrine, $form, $request, $category)
    {
        $form->handleRequest($request);
     ...
     */
    public function deleteAct(ManagerRegistry $doctrine, $id)
    {
        $em = $doctrine->getManager();
     ...
     */
    public function editAct(ManagerRegistry $doctrine, $id, Request $request)
    {
        $em = $doctrine->getManager();
        $category = $em->getRepository('App:Category')->find($id);
        $form = $this->createForm(CategoryType::class, $category);
        ...
        if ($form->isSubmitted()) {
            ...
            return new Response('edit' . $category->getId());
        }
